...
2026-08-19、P0/P1修正後の `main` を対象に自動ゲートを再通過させています。数学I・A、II・B・C、数学IIIを外部教材なしで進めるための320概念・320ガイド・320レッスン・2,392問と、9つの100点模試を収録しています。最終3エージェント監査の結果は監査レポートに固定します。
