...
2026-08-18、監査対象の現行HEADを対象にした独立監査で、教材・学習ループ・保存復帰・模試エンジンの実装ゲートは **SUCCESS** になりました。数学I・A、II・B・C、数学IIIを外部教材なしで進めるための320概念・320ガイド・320レッスン・2,392問と、9つの100点模試を収録しています。
...
- 全概念：320
- 共テ幹線概念：239（`priority=core` の数学I・A・II・B・C）
