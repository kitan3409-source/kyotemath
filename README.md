...
2026-08-18、公開中の`main`を対象にした独立監査で、教材・学習ループ・保存復帰・模試エンジンの実装ゲートは **SUCCESS** になりました。数学I・A、II・B・C、数学IIIを外部教材なしで進めるための320概念・320ガイド・320レッスン・2,392問と、9つの100点模試を収録しています。
